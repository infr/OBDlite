...
"""
    ...
    def scanSerialOld(self):
        ...
        for i in range(256):
          ...
          except (OSError, serial.SerialException): # OSError for macOS
            pass
        for i in range(256):
          try: #scan USB ttyACM
    ...
    def scanSerial(self):
      """ Lists serial port names - http://stackoverflow.com/questions/12090503/listing-available-com-ports-with-python
